...
You can find this example at https://github.com/wandb/examples/blob/master/tf-cnn-fashion/train.py

You can find the results of running this code at https://app.wandb.ai/wandb/tensorflow-fashion-mnist/runs/b7ruskvv 
